...
const providers = ['ali', 'chatfire', 'colab-ltxv', 'gemini', 'minimax', 'openai', 'openrouter', 'vidu', 'volcengine']
...
const providerPresets = {
  ...
  video: {
    'colab-ltxv': { label: 'Colab LTXV', baseUrl: '', models: ['ltxv-0.9.7-13b-distilled-q6_k'] },
