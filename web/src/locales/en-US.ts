export default {
  ...
  workflow: {
    ...
    batchGenerateSelectedProps: 'Batch Generate Selected Props',
    generateAllImagesFirst: 'Please generate all character, scene, and key prop images before splitting shots',
    ...
    propImageComplete: 'Prop image generation completed!',
