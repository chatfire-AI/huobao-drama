export default {
  ...
  workflow: {
    ...
    batchGenerateSelectedProps: '批量生成选中道具',
    generateAllImagesFirst: '请先生成所有角色、场景和关键道具图片后再进行分镜拆分',
  ...
  video: {
    ...
    novelNarrationTitle: '小说类型旁白',
    novelNarrationSubtitle: '基于每个分镜的无声视频与分镜内容，自动生成旁白并回写到“对白/旁白”字段',
    overwriteExistingNarration: '覆盖已有旁白',
    generateAllNovelNarration: '一键生成全部旁白',
    shotNumber: '分镜号',
    shotTitle: '分镜标题',
    videoStatus: '视频状态',
    silentVideoReady: '有无声视频',
    silentVideoMissing: '暂无视频',
    novelNarration: '旁白内容',
    noNarration: '暂无旁白',
    dubbing: '配音',
    dubbingInDevelopment: '配音功能开发中',
    narrationGenerateSuccess: '旁白生成成功',
    narrationGenerateFailed: '旁白生成失败',
    narrationSkipped: '已跳过（分镜已有旁白）',
    narrationBatchSuccess: '旁白生成完成：成功 {success} 条，跳过 {skipped} 条',
    narrationBatchPartial: '旁白生成完成：成功 {success} 条，失败 {failed} 条，跳过 {skipped} 条',
    noMergeYet: '还没有合成过视频',
